  ...
  <div style={{ background: item.color, borderRadius: radius.xl + 2, padding: isMobile ? "32px 24px" : "44px 40px", position: "relative", overflow: "hidden", ...animation.fadeIn(inView, idx * 0.15) }}>
    ...
    {item.points.map((pt, i) => (
      <p key={i} style={{
        ...
        margin: i < item.points.length - 1 ? `0 0 ${spacing.md}px` : 0,
...
const AboutUs = () => {
  ...
  return (
    <div style={{
      ...
      <style>{`
        ...
        @keyframes heroMove      { 0%,100%{transform:translateX(0px) rotate(0deg)} 25%{transform:translateX(18px) rotate(1.5deg)} 50%{transform:translateX(-18px) rotate(-1.5deg)} 75%{transform:translateX(12px) rotate(1deg)} }
        @keyframes shineMove     { 0%{left:-120%} 60%,100%{left:120%} }
        @keyframes miniFloat     { 0%,100%{transform:translateY(0)} 50%{transform:translateY(-10px)} }
      ...
      <div
        ...
        style={{
          ...
          alignItems: "center",
          marginTop: -70,
          padding: isMobile ? "80px 20px 60px" : isTablet ? "110px 40px 90px" : "0 20px",
        }}
      >
        {/* Animated orb blobs */}
        <div style={{ position: "absolute", top: "8%", left: "-6%", width: isMobile ? 240 : 400, height: isMobile ? 240 : 400, borderRadius: "50%", background: colors.accentTint15, filter: "blur(90px)", animation: "orbDrift1 12s ease-in-out infinite", pointerEvents: "none" }} />
        <div style={{ position: "absolute", bottom: "5%", right: "-8%", width: isMobile ? 260 : 460, height: isMobile ? 260 : 460, borderRadius: "50%", background: colors.primaryTint22, filter: "blur(110px)", animation: "orbDrift2 14s ease-in-out infinite", pointerEvents: "none" }} />
        <div style={{ position: "absolute", top: "55%", left: "40%", width: 200, height: 200, borderRadius: "50%", background: colors.accentTint8, filter: "blur(70px)", pointerEvents: "none" }} />

        {/* Dot grid */}
        <div style={{ position: "absolute", inset: 0, backgroundImage: `radial-gradient(${colors.whiteTint6} 1px, transparent 1px)`, backgroundSize: "36px 36px", opacity: 0.4 }} />

        {/* Accent line top */}
        <div style={{ position: "absolute", top: 0, left: 0, right: 0, height: 3, background: `linear-gradient(90deg, transparent, ${colors.accent}, transparent)`, opacity: 0.6 }} />

        <div style={{
          position: "relative", zIndex: 2,
          maxWidth: layout.maxWidthGrid, margin: "0 auto", width: "100%",
          display: "grid",
          ...
          <div style={{ animation: "heroFadeUp 0.8s ease both" }}>
            ...
            {/* Eyebrow badge */}
            <div style={{ display: "inline-flex", alignItems: "center", gap: 10, padding: "8px 18px", borderRadius: 40, background: colors.whiteTint7, border: `1px solid ${colors.borderLight}`, marginBottom: 28, backdropFilter: "blur(8px)" }}>
              <div style={{ width: 8, height: 8, borderRadius: "50%", background: colors.accent, animation: "pulse 2s ease-in-out infinite" }} />
              <span style={{
                color: colors.accent, fontSize: t.size.xs,
                fontWeight: t.weight.extrabold, letterSpacing: "0.18em",
                textTransform: "uppercase", fontFamily: t.fontFamily.secondaryHeading,
              }}>
                About RAM
              </span>
            </div>
            ...
            {/* Heading */}
            <h1 style={{ margin: 0, lineHeight: 1.05, letterSpacing: "-0.04em", fontFamily: t.fontFamily.heading }}>
              <span style={{ display: "block", color: colors.white, fontSize: isMobile ? "2.2rem" : "3.6rem", fontWeight: 900, marginBottom: spacing.xs }}>Smart</span>
              <span style={{
                display: "block",
                background: `linear-gradient(90deg, ${colors.accent}, #f5c842)`,
                WebkitBackgroundClip: "text", WebkitTextFillColor: "transparent", backgroundClip: "text",
                fontSize: isMobile ? "2.2rem" : "3.6rem", fontWeight: 300, marginBottom: spacing.xs,
              }}>Digital</span>
              <span style={{ display: "block", color: colors.white, fontSize: isMobile ? "1.8rem" : "2.8rem", fontWeight: 900 }}>Experiences</span>
            </h1>

            {/* Divider accent */}
            <div style={{ display: "flex", alignItems: "center", gap: 10, margin: "22px 0" }}>
              <div style={{ width: 44, height: 3, background: colors.accent, borderRadius: 2 }} />
              <div style={{ width: 14, height: 3, background: colors.accentTint20, borderRadius: 2 }} />
              <div style={{ width: 6, height: 3, background: colors.accentTint15, borderRadius: 2 }} />
            </div>

            {/* Description */}
            <p style={{
              color: colors.textOnDark60,
              fontSize: isMobile ? t.size.base : "1.1rem",
              lineHeight: 1.9,
              maxWidth: 560,
              margin: "0 0 36px",
              fontFamily: t.fontFamily.paragraph,
            }}>
              We create modern websites, scalable applications, and intelligent digital solutions that help businesses grow faster and stand out in the digital world.
            </p>
  ...
  >
    ...
    Explore More
          ...
          {/* ── RIGHT — unchanged from original ── */}
          <div style={{ position: "relative", display: "flex", justifyContent: "center", alignItems: "center", minHeight: isMobile ? 420 : 520, marginTop: isMobile ? 30 : 0, animation: "heroMove 8s ease-in-out infinite", transformOrigin: "center", width: "100%" }}>
            {/* Floating Glow */}
            <div style={{ position: "absolute", width: isMobile ? 260 : 420, height: isMobile ? 260 : 420, borderRadius: "50%", background: colors.accentTint12, filter: isMobile ? "blur(60px)" : "blur(90px)" }} />

            {/* Main Card */}
            <div style={{ width: isMobile ? "100%" : 360, maxWidth: 360, background: colors.whiteTint7, backdropFilter: "blur(18px)", border: `1px solid ${colors.borderLight}`, borderRadius: radius.xl + 8, padding: isMobile ? "26px 22px" : "34px 30px", boxShadow: shadows.primary, position: "relative", overflow: "hidden", zIndex: 2 }}>
              {/* Shine */}
              ...
              <p style={{
                ...
                lineHeight: 1.9,
                margin: 0,
                fontSize: isMobile ? t.size.sm : t.size.md,
                fontFamily: t.fontFamily.paragraph,
              }}>
                From websites and mobile apps to automation and analytics — we help brands create modern digital experiences that scale.
              </p>

              {/* Tags */}
              <div style={{ display: "flex", flexWrap: "wrap", gap: 10, marginTop: 28 }}>
                {["Web Apps", "Cloud", "Analytics", "Automation"].map((tag, i) => (
                  <div key={i} style={{
                    padding: isMobile ? "8px 13px" : "9px 16px",
                    borderRadius: radius.pill,
                    background: colors.whiteTint10,
                    color: colors.accent,
                    fontSize: isMobile ? "0.68rem" : t.size.xs,
                    fontWeight: t.weight.bold,
            ...
            {/* Floating Mini Card */}
            <div style={{ position: "absolute", top: isMobile ? -10 : 30, right: isMobile ? 0 : 10, background: gradients.accent, color: colors.white, borderRadius: radius.xl, padding: isMobile ? "14px 16px" : "20px 22px", width: isMobile ? 150 : 190, boxShadow: shadows.ctaLg, animation: "miniFloat 4s ease-in-out infinite", zIndex: 3 }}>
              <div style={{ fontSize: isMobile ? "1.3rem" : "1.9rem", fontWeight: 900, lineHeight: 1, fontFamily: t.fontFamily.heading }}>
                Creative
              </div>
              <div style={{ fontSize: isMobile ? "0.6rem" : t.size.xs, marginTop: 8, lineHeight: 1.6, letterSpacing: "0.06em", textTransform: "uppercase", fontFamily: t.fontFamily.secondaryHeading }}>
                Design + Development
              </div>
            </div>
          </div>
        ...
        {/* Bottom Fade */}
        {/* <div style={{ position: "absolute", bottom: 0, left: 0, right: 0, height: 120, background: `linear-gradient(to top, ${colors.bgPage}, transparent)` }} /> */}
      </div>
        ...
        <div ref={aboutRef} style={{ maxWidth: layout.maxWidthGrid, margin: "0 auto", padding: secPad }}>
          ...
          <div style={{ display: "grid", gridTemplateColumns: isMobile ? "1fr" : "1fr 1fr", gap: isMobile ? 32 : 56, alignItems: "center" }}>
            ...
            <div style={{ ...animation.fadeIn(aboutIn, 0, "left") }}>
              <p style={{ color: colors.accent, fontWeight: t.weight.bold, fontSize: t.size.xs, letterSpacing: "0.14em", textTransform: "uppercase", margin: `0 0 ${spacing.md}px`, fontFamily: t.fontFamily.secondaryHeading }}>
                Our Features
              </p>
              <h2 style={{ fontSize: isMobile ? "1.5rem" : "2rem", fontWeight: 900, color: colors.textHeading, margin: `0 0 ${spacing.lg}px`, lineHeight: t.lineHeight.normal, letterSpacing: "-0.02em", fontFamily: t.fontFamily.heading }}>
                Smart, Scalable &amp; Future-Ready Digital Solutions
              </h2>
              <p style={{ color: colors.textBodyAlt, fontSize: t.size.lg, lineHeight: t.lineHeight.body, margin: `0 0 16px`, fontFamily: t.fontFamily.paragraph }}>
            ...
            <div style={{ ...animation.fadeIn(aboutIn, 0.2, "right") }}>
              <div style={{ background: gradients.primary, borderRadius: radius.xl + 4, padding: isMobile ? "28px 22px" : "40px 36px", position: "relative", overflow: "hidden" }}>
                ...
                <p style={{ color: colors.accent, fontWeight: t.weight.bold, fontSize: t.size.xs, letterSpacing: "0.12em", textTransform: "uppercase", margin: `0 0 ${spacing.md}px`, position: "relative", fontFamily: t.fontFamily.secondaryHeading }}>
                  Our Capabilities
                </p>
                <p style={{ color: colors.textOnDarkSub, fontSize: t.size.md, lineHeight: t.lineHeight.body, margin: `0 0 ${spacing.xl}px`, position: "relative", fontFamily: t.fontFamily.paragraph }}>
                ...
                <p style={{ color: colors.textOnDarkSub, fontSize: t.size.md, lineHeight: t.lineHeight.body, margin: `0 0 28px`, position: "relative", fontFamily: t.fontFamily.paragraph }}>
                ...
                {["End-to-end product development", "Data-driven decision making", "Always-on client support"].map((pt, i) => (
                  <div key={i} style={{ display: "flex", alignItems: "center", gap: 10, marginBottom: 10, position: "relative" }}>
                    ...
                    <span style={{ color: colors.textOnDark85, fontSize: t.size.base, fontWeight: t.weight.medium, fontFamily: t.fontFamily.paragraph }}>
                      {pt}
                    </span>
                  </div>
                ))}
        ...
        <div ref={testRef} style={{ maxWidth: layout.maxWidthGrid, margin: "0 auto", padding: secPad }}>
          ...
          <div style={{ position: "relative", overflow: "hidden", ...animation.fadeIn(testIn) }}>
            <div style={{ background: gradients.card, borderRadius: radius.xl + 4, padding: isMobile ? "36px 24px" : "60px 72px", textAlign: "center", minHeight: isMobile ? 280 : 260, display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center", position: "relative", overflow: "hidden" }}>
              ...
              <p style={{
                fontSize: isMobile ? t.size.lg : 19,
                fontWeight: t.weight.bold,
              ...
              <div style={{ display: "flex", alignItems: "center", gap: 12, justifyContent: "center" }}>
                <div style={{ width: iconSize.avatar - 2, height: iconSize.avatar - 2, borderRadius: radius.full, background: gradients.avatar, display: "flex", alignItems: "center", justifyContent: "center", color: colors.accent, fontWeight: t.weight.extrabold, fontSize: t.size.base, fontFamily: t.fontFamily.heading }}>
                  {TESTIMONIALS[activeTest].avatar}
                </div>
                <div style={{ textAlign: "left" }}>
                  <p style={{ margin: 0, fontWeight: t.weight.extrabold, fontSize: t.size.md, color: colors.textHeading, fontFamily: t.fontFamily.heading }}>
                    {TESTIMONIALS[activeTest].name}
                  </p>
                  <p style={{ margin: 0, fontSize: t.size.sm, color: colors.textMuted, fontFamily: t.fontFamily.paragraph }}>
      ...
      <div style={{ maxWidth: layout.maxWidthGrid, margin: "0 auto", padding: isMobile ? `0 ${layout.sectionPadXMob}px 52px` : `0 ${layout.sectionPadX}px 64px` }}>
        <div style={{ background: gradients.cta, borderRadius: isMobile ? radius.lg : radius.xl + 2, padding: isMobile ? "40px 24px" : "56px 48px", display: "flex", flexDirection: isMobile ? "column" : "row", alignItems: isMobile ? "flex-start" : "center", justifyContent: "space-between", gap: isMobile ? spacing.xl : 32, position: "relative", overflow: "hidden" }}>
          ...
          <div style={{ position: "relative" }}>
            <p style={{ color: colors.accent, fontWeight: t.weight.bold, fontSize: t.size.sm, letterSpacing: "0.1em", textTransform: "uppercase", margin: `0 0 10px`, fontFamily: t.fontFamily.secondaryHeading }}>
              Ready to get started?
            </p>
            <h3 style={{ color: colors.white, fontSize: isMobile ? "1.3rem" : "1.8rem", fontWeight: t.weight.extrabold, margin: `0 0 ${spacing.sm}px`, lineHeight: t.lineHeight.normal, fontFamily: t.fontFamily.heading }}>
              Let's build something great together
            </h3>
            <p style={{ color: colors.textOnDark60, fontSize: t.size.md, margin: 0, fontFamily: t.fontFamily.paragraph }}>
...
//       position: "absolute",
//       inset: 0,
//       backgroundImage: `linear-gradient(${colors.whiteTint4} 1px, transparent 1px),
//       linear-gradient(90deg, ${colors.whiteTint4} 1px, transparent 1px)`,
...
//         }}
//       >
//         We create modern websites, scalable applications, and
//         intelligent digital solutions that help businesses grow
//         faster and stand out in the digital world.
//       </p>
...
//       }}
//     >
//       From websites and mobile apps to automation and analytics —
//       we help brands create modern digital experiences that scale.
//     </p>
...
//     <div
//       style={{
//         fontSize: isMobile ? "0.6rem" : t.size.xs,
//         marginTop: 8,
//         lineHeight: 1.6,
...
//       right: 0,
//       height: 120,
//       background: `linear-gradient(to top, ${colors.bgPage}, transparent)`,
//     }}
//   />
// </div>
