...
//   stats: [
//     { value: "80%", label: "Reduction in admin workload" },
//     { value: "100%", label: "Parent communication digitized" },
//     { value: "2,000+", label: "Children managed" },
//     { value: "4.9★", label: "Parent satisfaction score" },
//   ],
//   challenge: {
//     title: "The Challenge",
//     body:
//       "Preschools and daycare centres were managing attendance in paper registers, sending fee reminders via individual WhatsApp messages, and handling staff shifts on physical notice boards. Parent communication was inconsistent, daily child care updates were not shared in real time, and incident records were maintained in physical files — creating gaps in child safety and parent trust.",
//     points: [
//       "Paper-based attendance, care logs, and incident records",
//       "Manual fee collection and reminder calls",
//       "No real-time parent notifications on child activities or pickup",
//       "Staff scheduling done on whiteboards with no leave management",
//       "No structured milestone or development tracking for children",
//       "Disconnected systems for admissions, fees, and communication",
//     ],
//   },
//   solution: {
//     title: "Our Solution",
//     body:
//       "A mobile-first Preschool ERP built specifically for early childhood education workflows, with dedicated portals for administrators, teachers, and parents — covering everything from admissions to graduation.",
//     modules: [
//       {
//         icon: "🎓",
//         name: "Admissions & Inquiry Management",
//         desc: "Online admission forms, lead and inquiry tracking, trial class scheduling, waitlist management, age eligibility validation, document verification, and digital onboarding.",
//       },
//       {
//         icon: "🧒",
//         name: "Child Profile Management",
//         desc: "Detailed child records including medical conditions, allergies, medications, sleep and food preferences, vaccination records, pickup authorization lists, and behavioral notes.",
//       },
//       {
//         icon: "✅",
//         name: "Daily Child Tracking",
//         desc: "Attendance and QR-based check-in/check-out, meal tracking, nap and sleep monitoring, hygiene logs, mood tracking, activity participation, and health observations — with automatic parent updates.",
//       },
//       {
//         icon: "🔒",
//         name: "Safe Pickup & Child Security",
//         desc: "OTP and QR-based pickup verification, authorized guardian validation, pickup history logs, emergency pickup approvals, late pickup monitoring, and instant parent notifications.",
//       },
//       {
//         icon: "📱",
//         name: "Parent Communication App",
//         desc: "Real-time updates feed, teacher-parent messaging, emergency alerts, announcements, digital diary, homework sharing, event photos and videos, and activity albums.",
//       },
//       {
//         icon: "📚",
//         name: "Classroom & Activity Management",
//         desc: "Weekly curriculum management, story sessions, music and dance activities, art and craft programs, indoor and outdoor activities, learning themes, teacher observations, and photo uploads.",
//       },
//       {
//         icon: "📈",
//         name: "Child Development & Milestones",
//         desc: "Track cognitive development, motor skills, communication abilities, social interaction, and emotional growth. Generate development reports, observation summaries, growth charts, and parent review reports.",
//       },
//       {
//         icon: "💳",
//         name: "Smart Fee Management",
//         desc: "Admission fees, monthly fees, daycare charges, activity and transport fees, meal plans, installments, sibling discounts, online payments, and automated reminders.",
//       },
//       {
//         icon: "👩‍💼",
//         name: "Staff & Classroom Operations",
//         desc: "Teacher attendance, shift scheduling, training records, background verification, caretaker management, and performance tracking.",
//       },
//       {
//         icon: "🚌",
//         name: "Transport Management",
//         desc: "Live GPS tracking, pickup and drop alerts, route management, guardian notifications, and transport attendance.",
//       },
//       {
//         icon: "🏥",
//         name: "Health & Medical Management",
//         desc: "Vaccination schedules, allergy alerts, medicine logs, incident reports, injury tracking, and temperature checks.",
//       },
//       {
//         icon: "🏢",
//         name: "Multi-Branch & Franchise Ready",
//         desc: "Multi-branch monitoring, shared curriculum management, centralized reporting, branch performance analytics, staff transfer management, and unified operational controls.",
//       },
//     ],
//   },
//   results: {
//     title: "Results Achieved",
//     body:
//       "Deployed across preschool networks and daycare centres, helping institutions automate operations, improve child safety, and deliver real-time parent engagement through a unified digital platform.",
//     outcomes: [
//       { metric: "Admin hours per week", before: "30+ hrs", after: "6 hrs" },
//       { metric: "Parent communication", before: "Manual WhatsApp messages", after: "Real-time app updates" },
//       { metric: "Fee collection rate", before: "71%", after: "99.8%" },
//       { metric: "Child safety & pickup verification", before: "Manual registers", after: "OTP / QR-based system" },
//       { metric: "Development tracking", before: "Paper report cards", after: "Digital milestone reports" },
//       { metric: "Staff scheduling conflicts", before: "Weekly issues", after: "Eliminated" },
//     ],
//   },
//   testimonial: {
//     quote:
//       "Parents love the real-time updates on their child's activities, meals, and mood. Our staff love the simple daily tracking tools. And I can monitor everything — admissions, fees, attendance, and development — right from my phone without being on site.",
//     author: "Centre Director",
//     org: "Preschool Network, Pune",
//   },
//   techStack: [
//     "React",
//     "Next.js",
...
//   accent: "#e8a020",
//   overview:
//     "Choosing the right stream, career, or specialization is one of the most important decisions in a student's life — yet most students still rely on confusion, assumptions, or generic guidance. Our Student Career Assessment & Intelligence Platform solves this through scientifically designed assessments, psychometric analysis, career intelligence, personalized recommendations, and counselling workflows. It is a complete Career Intelligence Ecosystem built for schools, counsellors, students, and educational organizations.",
//   stats: [
//     { value: "50,000+", label: "Assessments conducted" },
//     { value: "4 Stages", label: "Class 6 to Postgrad" },
//     { value: "AI-Ready", label: "Recommendation engine" },
...
//     title: "The Challenge",
//     body:
//       "Students, parents, and counsellors were relying on generic advice, manual workflows, and disconnected tools for career guidance. There was no scientific or personalized system to help students discover their aptitude, personality, and the right career pathway — leading to poor stream selections, wrong career choices, and missed opportunities.",
//     points: [
//       "Generic, one-size-fits-all career recommendations",
//       "Manual counselling workflows with no digital tracking",
//       "No psychometric or aptitude-based student profiling",
//       "Limited analytics for schools and counselling organizations",
//       "No structured assessment system for different academic stages",
//       "Parents had zero visibility into student career development",
//     ],
//   },
...
//     title: "Our Solution",
//     body:
//       "We built a scalable, multi-tenant Career Intelligence Ecosystem that combines psychometric assessments, AI-ready recommendations, dynamic student personalization, counselling workflows, and powerful analytics — tailored for every academic stage from Class 6 to postgraduation.",
//     modules: [
//       {
//         icon: "🧠",
//         name: "Smart Assessment Engine",
//         desc: "Create and conduct aptitude tests, psychometric assessments, personality tests, stream selection tests, and career orientation assessments with drag-and-drop builder, randomization, timer configuration, and mobile-friendly delivery.",
//       },
//       {
//         icon: "📚",
//         name: "Advanced Question Bank",
//         desc: "Supports MCQ, multi-select, logical reasoning, image-based, personality-based, and psychometric question types — categorized by aptitude, verbal ability, quantitative ability, personality, interests, and career orientation.",
//       },
//       {
//         icon: "🤖",
//         name: "AI-Ready Recommendation Engine",
//         desc: "Intelligently recommends career paths, suitable streams, specializations, skill development areas, and higher study options based on aptitude analysis, personality mapping, interest profiling, and academic performance.",
//       },
//       {
//         icon: "🎯",
//         name: "Dynamic Student Personalization",
//         desc: "Adapts recommendations based on student profile and academic stage — commerce-oriented students get CA, Finance, Analytics; creative students get Design, Animation, UI/UX; science students get Engineering, Medical, Research, and more.",
//       },
//       {
//         icon: "📊",
//         name: "Comprehensive Career Reports",
//         desc: "Generate detailed, visually rich reports with aptitude analysis, personality insights, stream suitability, career recommendations, strengths and weaknesses, improvement roadmaps, percentile analysis, radar charts, and heatmaps.",
//       },
//       {
//         icon: "📅",
//         name: "Counselling Workflow Management",
//         desc: "Digitize and scale career counselling with counsellor assignment, session scheduling, counselling notes, follow-up tracking, recommendation tracking, and support for both online and offline counselling.",
//       },
//       {
//         icon: "👨‍👩‍👧",
//         name: "Parent Engagement & Visibility",
//         desc: "Parents gain complete visibility into student strengths, assessment reports, career recommendations, counselling summaries, progress tracking, and improvement areas — helping families make informed academic decisions.",
//       },
//       {
//         icon: "🎓",
//         name: "Stage-Wise Student Journeys",
//         desc: "Tailored experiences for Class 6–8 (gamified interest discovery), Class 9–10 (stream selection), Class 11–12 (career alignment and college readiness), and Graduation/PG students (specialization and career transitions).",
//       },
//       {
//         icon: "🏢",
//         name: "Multi-Tenant SaaS Platform",
//         desc: "Built for schools, career counselling organizations, coaching institutes, and educational consultants — each with isolated data, custom branding, independent analytics, role-based access, and secure reporting.",
//       },
//       {
//         icon: "📢",
//         name: "Notifications & Communication",
//         desc: "Integrated WhatsApp, email, SMS, and push notifications with automated reminders for assessments, reports, counselling sessions, follow-ups, and progress tracking.",
//       },
//     ],
//   },
...
//     title: "Results Achieved",
//     body:
//       "Deployed across schools, counselling organizations, and coaching institutes — enabling data-driven career guidance, scalable assessment operations, and measurable improvements in student career clarity.",
//     outcomes: [
//       { metric: "Career guidance approach", before: "Generic advice", after: "Personalized intelligence" },
//       { metric: "Counselling workflow", before: "Manual WhatsApp & calls", after: "Centralized digital system" },
//       { metric: "Assessment delivery", before: "Paper-based or basic forms", after: "Scalable online platform" },
//       { metric: "Student profiling", before: "None", after: "Psychometric + aptitude mapping" },
//       { metric: "Parent visibility", before: "Zero", after: "Full report & progress access" },
//       { metric: "Organization-wide analytics", before: "Not available", after: "Real-time institution dashboards" },
//     ],
//   },

//   testimonial: {
//     quote:
//       "This platform completely transformed how we deliver career guidance. From scientific assessments and personalized reports to counselling workflows and parent dashboards — everything is now structured, data-driven, and scalable. Students and parents finally have clarity on the right career path.",
//     author: "Director",
//     org: "Career Counselling Organization, Pune",
//   },
...
import {
  // CMS icons
  UserPlus, BookOpen, CreditCard, ClipboardList, FileText, CalendarDays,
  Bell, Video, Lock, BarChart2,
  // Preschool ERP icons
  GraduationCap, Baby, CheckSquare, ShieldCheck, Smartphone, BookMarked,
  TrendingUp, Wallet, Users, Bus, HeartPulse, Building2,
  // Career Assessment icons
  Brain, Database, Bot, Target, PieChart, CalendarCheck,
  UsersRound, Milestone, Layers, MessageSquare,
  // K+12 ERP icons
  ClipboardCheck, UserCog, UserCheck, ListChecks, ScrollText,
  DollarSign, BookCopy, Truck, Library, Package, Megaphone, LayoutDashboard,
} from "lucide-react";
import { colors, typography, spacing, radius, shadows, layout } from "../theme/theme";
...
export const CASE_STUDIES = {
  ...
  2: {
    ...
    challenge: {
      title: "The Challenge",
      body: "Preschools and daycare centres were managing attendance in paper registers, sending fee reminders via individual WhatsApp messages, and handling staff shifts on physical notice boards. Parent communication was inconsistent, daily child care updates were not shared in real time, and incident records were maintained in physical files — creating gaps in child safety and parent trust.",
      points: [
        "Paper-based attendance, care logs, and incident records",
        "Manual fee collection and reminder calls",
        "No real-time parent notifications on child activities or pickup",
    ...
    solution: {
      title: "Our Solution",
      body: "A mobile-first Preschool ERP built specifically for early childhood education workflows, with dedicated portals for administrators, teachers, and parents — covering everything from admissions to graduation.",
      modules: [
        { icon: GraduationCap, name: "Admissions & Inquiry Management", desc: "Online admission forms, lead and inquiry tracking, trial class scheduling, waitlist management, age eligibility validation, document verification, and digital onboarding." },
        { icon: Baby,          name: "Child Profile Management",        desc: "Detailed child records including medical conditions, allergies, medications, sleep and food preferences, vaccination records, pickup authorization lists, and behavioral notes." },
        { icon: CheckSquare,   name: "Daily Child Tracking",            desc: "Attendance and QR-based check-in/check-out, meal tracking, nap and sleep monitoring, hygiene logs, mood tracking, activity participation, and health observations — with automatic parent updates." },
        { icon: ShieldCheck,   name: "Safe Pickup & Child Security",    desc: "OTP and QR-based pickup verification, authorized guardian validation, pickup history logs, emergency pickup approvals, late pickup monitoring, and instant parent notifications." },
        { icon: Smartphone,    name: "Parent Communication App",        desc: "Real-time updates feed, teacher-parent messaging, emergency alerts, announcements, digital diary, homework sharing, event photos and videos, and activity albums." },
        { icon: BookMarked,    name: "Classroom & Activity Management", desc: "Weekly curriculum management, story sessions, music and dance activities, art and craft programs, indoor and outdoor activities, learning themes, teacher observations, and photo uploads." },
        { icon: TrendingUp,    name: "Child Development & Milestones",  desc: "Track cognitive development, motor skills, communication abilities, social interaction, and emotional growth. Generate development reports, observation summaries, growth charts, and parent review reports." },
        { icon: Wallet,        name: "Smart Fee Management",            desc: "Admission fees, monthly fees, daycare charges, activity and transport fees, meal plans, installments, sibling discounts, online payments, and automated reminders." },
        { icon: Users,         name: "Staff & Classroom Operations",    desc: "Teacher attendance, shift scheduling, training records, background verification, caretaker management, and performance tracking." },
        { icon: Bus,           name: "Transport Management",            desc: "Live GPS tracking, pickup and drop alerts, route management, guardian notifications, and transport attendance." },
        { icon: HeartPulse,    name: "Health & Medical Management",     desc: "Vaccination schedules, allergy alerts, medicine logs, incident reports, injury tracking, and temperature checks." },
        { icon: Building2,     name: "Multi-Branch & Franchise Ready",  desc: "Multi-branch monitoring, shared curriculum management, centralized reporting, branch performance analytics, staff transfer management, and unified operational controls." },
      ],
    },
    results: {
      title: "Results Achieved",
      body: "Deployed across preschool networks and daycare centres, helping institutions automate operations, improve child safety, and deliver real-time parent engagement through a unified digital platform.",
      outcomes: [
        { metric: "Admin hours per week",                    before: "30+ hrs",                   after: "6 hrs" },
        { metric: "Parent communication",                    before: "Manual WhatsApp messages",  after: "Real-time app updates" },
        { metric: "Fee collection rate",                     before: "71%",                       after: "99.8%" },
    ...
    testimonial: {
      quote: "Parents love the real-time updates on their child's activities, meals, and mood. Our staff love the simple daily tracking tools. And I can monitor everything — admissions, fees, attendance, and development — right from my phone without being on site.",
      author: "Centre Director",
      org: "Preschool Network, Pune",
    },
    techStack: ["React", "Redux", "Django", "MySQL", "Redis", "AWS", "Razorpay", "WhatsApp API"],
  ...
  3: {
    ...
    heroColor: "#1a3e8c",
    accent: "#e8a020",
    overview: "Choosing the right stream, career, or specialization is one of the most important decisions in a student's life — yet most students still rely on confusion, assumptions, or generic guidance. Our Student Career Assessment & Intelligence Platform solves this through scientifically designed assessments, psychometric analysis, career intelligence, personalized recommendations, and counselling workflows. It is a complete Career Intelligence Ecosystem built for schools, counsellors, students, and educational organizations.",
    stats: [
      { value: "50,000+",      label: "Assessments conducted" },
      { value: "4 Stages",     label: "Class 6 to Postgrad" },
      { value: "AI-Ready",     label: "Recommendation engine" },
    ...
    challenge: {
      title: "The Challenge",
      body: "Students, parents, and counsellors were relying on generic advice, manual workflows, and disconnected tools for career guidance. There was no scientific or personalized system to help students discover their aptitude, personality, and the right career pathway — leading to poor stream selections, wrong career choices, and missed opportunities.",
      points: [
        "Generic, one-size-fits-all career recommendations",
        "Manual counselling workflows with no digital tracking",
        "No psychometric or aptitude-based student profiling",
    ...
    solution: {
      title: "Our Solution",
      body: "We built a scalable, multi-tenant Career Intelligence Ecosystem that combines psychometric assessments, AI-ready recommendations, dynamic student personalization, counselling workflows, and powerful analytics — tailored for every academic stage from Class 6 to postgraduation.",
      modules: [
        { icon: Brain,         name: "Smart Assessment Engine",          desc: "Create and conduct aptitude tests, psychometric assessments, personality tests, stream selection tests, and career orientation assessments with drag-and-drop builder, randomization, timer configuration, and mobile-friendly delivery." },
        { icon: Database,      name: "Advanced Question Bank",           desc: "Supports MCQ, multi-select, logical reasoning, image-based, personality-based, and psychometric question types — categorized by aptitude, verbal ability, quantitative ability, personality, interests, and career orientation." },
        { icon: Bot,           name: "AI-Ready Recommendation Engine",   desc: "Intelligently recommends career paths, suitable streams, specializations, skill development areas, and higher study options based on aptitude analysis, personality mapping, interest profiling, and academic performance." },
        { icon: Target,        name: "Dynamic Student Personalization",  desc: "Adapts recommendations based on student profile and academic stage — commerce-oriented students get CA, Finance, Analytics; creative students get Design, Animation, UI/UX; science students get Engineering, Medical, Research, and more." },
        { icon: PieChart,      name: "Comprehensive Career Reports",     desc: "Generate detailed, visually rich reports with aptitude analysis, personality insights, stream suitability, career recommendations, strengths and weaknesses, improvement roadmaps, percentile analysis, radar charts, and heatmaps." },
        { icon: CalendarCheck, name: "Counselling Workflow Management",  desc: "Digitize and scale career counselling with counsellor assignment, session scheduling, counselling notes, follow-up tracking, recommendation tracking, and support for both online and offline counselling." },
        { icon: UsersRound,    name: "Parent Engagement & Visibility",   desc: "Parents gain complete visibility into student strengths, assessment reports, career recommendations, counselling summaries, progress tracking, and improvement areas — helping families make informed academic decisions." },
        { icon: Milestone,     name: "Stage-Wise Student Journeys",      desc: "Tailored experiences for Class 6–8 (gamified interest discovery), Class 9–10 (stream selection), Class 11–12 (career alignment and college readiness), and Graduation/PG students (specialization and career transitions)." },
        { icon: Layers,        name: "Multi-Tenant SaaS Platform",       desc: "Built for schools, career counselling organizations, coaching institutes, and educational consultants — each with isolated data, custom branding, independent analytics, role-based access, and secure reporting." },
        { icon: MessageSquare, name: "Notifications & Communication",    desc: "Integrated WhatsApp, email, SMS, and push notifications with automated reminders for assessments, reports, counselling sessions, follow-ups, and progress tracking." },
      ],
    },
    results: {
      title: "Results Achieved",
      body: "Deployed across schools, counselling organizations, and coaching institutes — enabling data-driven career guidance, scalable assessment operations, and measurable improvements in student career clarity.",
      outcomes: [
        { metric: "Career guidance approach",        before: "Generic advice",             after: "Personalized intelligence" },
        { metric: "Counselling workflow",            before: "Manual WhatsApp & calls",    after: "Centralized digital system" },
        { metric: "Assessment delivery",             before: "Paper-based or basic forms", after: "Scalable online platform" },
    ...
    testimonial: {
      quote: "This platform completely transformed how we deliver career guidance. From scientific assessments and personalized reports to counselling workflows and parent dashboards — everything is now structured, data-driven, and scalable. Students and parents finally have clarity on the right career path.",
      author: "Director",
      org: "Career Counselling Organization, Pune",
    },
     techStack: ["React", "Redux", "Django", "MySQL", "Redis", "AWS", "Razorpay", "WhatsApp API"],
...
const ProductCaseStudy = ({ productId, onBack }) => {
  ...
  const [challengeRef, challengeVisible] = useInView(0.15);
  const [solutionRef,  solutionVisible]  = useInView(0.1);
  const [resultsRef,   resultsVisible]   = useInView(0.15);
  const [testRef,      testVisible]      = useInView(0.3);
  const [techRef,      techVisible]      = useInView(0.3);
  const [ctaRef,       ctaVisible]       = useInView(0.3);

  // Hero entrance
  const [heroReady, setHeroReady] = useState(false);
  useEffect(() => { const t = setTimeout(() => setHeroReady(true), 80); return () => clearTimeout(t); }, [productId]);
...
const AnimatedCTAButton = ({ accent, href, children }) => {
  ...
  return (
    <a
      ...
      style={{
        display: "inline-block",
        background: hov ? `${accent}ee` : accent,
        color: colors.white,
        fontWeight: typography.weight.bold,
        fontSize: 14,
        ...
        textDecoration: "none",
        whiteSpace: "nowrap",
        boxShadow: hov ? `0 8px 24px ${accent}60` : shadows.ctaLg,
